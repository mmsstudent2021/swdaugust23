...
// console.log(points.filter(point => {
//   console.log(point);
//   return point < 50
// }));
...
// console.log(
//   product.reduce((pv, cv) => {
//     // console.log(cv.price);
//     return pv + cv.price;
//   },0)
// );

// console.table(product.filter(el => el.price < 100))

// console.log(product.find(el => el.id === 7));

// console.table(product.filter(el => el.id === 7))

// id 7 or id 10 or 15 or 2 or 6
...
//   product.filter(
//     (el) =>
//       el.title.toLowerCase().search("wd") != -1 ||
//       el.description.toLowerCase().search("wd") != -1
//   )
// );
...
// const newArr = ["zzz", ...points, "aaa", ...fruits];

// console.log(points.sort((a,b) => b-a));

// console.log(fruits.sort((a, b) => a.charCodeAt() - b.charCodeAt()));
...
// console.log(fruits.splice(1,5,"aaa","bbb","cc"));
...
// အသီးတွေထဲက စကားလုံး ၅ လုံးပါတဲ့အသီးတွေကို အကြီးပြောင်းမယ် console မှာ list လုပ်ပြီးထုတ်ပြပါ
